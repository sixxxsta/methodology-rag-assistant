...
- `/dashboard` — EdAgent: 5 фаз цикла партнёрства; у каждого куратора свои **циклы** (компании и проекты изолированы, админ видит все); цикл можно удалить из списка (soft-delete)  
...
- `/dashboard/projects` — генерация ТЗ, утверждение, публикация в каталог (постоянно или на срок семестра; истёкшие снимаются Celery)  
- `/catalog` — каталог опубликованных проектов для студентов  
- `/teams` — студенческая команда (код приглашения; проект выбирает лидер)  
